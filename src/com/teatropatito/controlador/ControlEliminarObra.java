...
public void asignarListaObrasComboBox(){          
    ...
    public void cargarFunciones(){
        try {
            ...
            listaHorarios= baseDatosFunciones.consultar(" obra='"+ eliminarObra.getListaObras().getSelectedItem()+"'"+
            ...
            for (int i = 0; i <listaHorarios.size(); i++) {
                String[] datosObra= { listaHorarios.get(i).getNumero(),
                                    listaHorarios.get(i).getHoraInicio() +":"+ listaHorarios.get(i).getMinutoInicio(),
                                    listaHorarios.get(i).getHoraFinal()  +":"+ listaHorarios.get(i).getMinutoFinal(),
